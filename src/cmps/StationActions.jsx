export function StationActions({ onToggleSongSearch, isLikedStation, onSetLikedStation }) {
    ...
    return (
        <section className="station-actions">
            ...
            {isLikedStation ? 
            <button className="like-btn" title="remove from likes" onClick={() => onSetLikedStation(false)}><svg className='liked' xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
            ...
            <button className="like-btn" title="add to likes" onClick={() => onSetLikedStation(true)}><svg className='unliked' width='24' height='24' xmlns='http://www.w3.org/2000/svg'  fillRule='evenodd' clipRule='evenodd'>
