            ...
            <div className="song-actions">
              ...
              {!isLiked ? (
                <button className="like-btn" onClick={setLikeSong}>
                  <svg className='unliked' width='24' height='24' xmlns='http://www.w3.org/2000/svg'  fillRule='evenodd' clipRule='evenodd'>
                ...
                <button className="like-btn" onClick={setUnlikeSong}>
                  <svg className='liked' xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
